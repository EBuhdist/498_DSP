...
_KNL_swi = KNL_swi;
_SWI_Audio = SWI_Audio;
_TSK_idle = TSK_idle;
_audioTSK = audioTSK;
_buttonTSK = buttonTSK;
_fftTSK = fftTSK;
...
-lbios5502.a55L        /* 5502 and compatible chips */
...
SECTIONS {
       ...
       /* no HWI stubs are necessary */
        ...
        .audioTSK$stk: block(0x20000){
            *(.audioTSK$stk)
        } > DARAM PAGE 0

        .buttonTSK$stk: block(0x20000){
            *(.buttonTSK$stk)
        } > DARAM PAGE 0

        .fftTSK$stk: block(0x20000){
            *(.fftTSK$stk)
        } > DARAM PAGE 0
       ...
       .hst0: block(0x20000) align = 0x4 {} > DARAM PAGE 0
        ...
        .audioMBX$que: block(0x20000) align = 0x4 {
            audioMBX$queElems = .;
            . += 400;
        } > DARAM PAGE 0
